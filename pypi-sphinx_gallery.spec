...
Version  : 0.13.0
Release  : 17
URL      : https://files.pythonhosted.org/packages/4d/43/9d197848fa1867fb10d0561c9124984bb6f49bc05236482384290d03170c/sphinx-gallery-0.13.0.tar.gz
...
%prep
%setup -q -n sphinx-gallery-0.13.0
cd %{_builddir}/sphinx-gallery-0.13.0
pushd ..
cp -a sphinx-gallery-0.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681749217
