...
Source0  : https://files.pythonhosted.org/packages/c7/8c/45cf5c639fcafeb81cb7afbf922a77aa683776215e40013d2e7d37dcec99/sphinx_gallery-0.17.0.tar.gz
...
%prep
%setup -q -n sphinx_gallery-0.17.0
cd %{_builddir}/sphinx_gallery-0.17.0
pushd ..
cp -a sphinx_gallery-0.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721664881
