...
Version  : 0.12.2
Release  : 16
URL      : https://files.pythonhosted.org/packages/b5/19/dbc4997a8c1ad2ce88a723aebdd923da37aaf24ad3a4a4cfe7bd5c057259/sphinx-gallery-0.12.2.tar.gz
...
%prep
%setup -q -n sphinx-gallery-0.12.2
cd %{_builddir}/sphinx-gallery-0.12.2
pushd ..
cp -a sphinx-gallery-0.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678721538
