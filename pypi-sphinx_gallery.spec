...
Source0  : https://files.pythonhosted.org/packages/ac/84/e4b4cde6ea2f3a1dd7d523dcf28260e93999b4882cc352f8bc6a14cbd848/sphinx_gallery-0.18.0.tar.gz
...
%prep
%setup -q -n sphinx_gallery-0.18.0
cd %{_builddir}/sphinx_gallery-0.18.0
pushd ..
cp -a sphinx_gallery-0.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728484443
