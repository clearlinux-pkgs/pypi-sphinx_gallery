...
Source0  : https://files.pythonhosted.org/packages/aa/22/5bcce07215e1c4b0511b3881b9001c963dad7a639201cdc5746ea39862d5/sphinx-gallery-0.15.0.tar.gz
...
%prep
%setup -q -n sphinx-gallery-0.15.0
cd %{_builddir}/sphinx-gallery-0.15.0
pushd ..
cp -a sphinx-gallery-0.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702072002
