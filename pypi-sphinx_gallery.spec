...
Source0  : https://files.pythonhosted.org/packages/18/a5/dc7e0dafcbb476bc460b2cdfb00882b7334a0f63e707c2407a40d1c13395/sphinx_gallery-0.17.1.tar.gz
...
%prep
%setup -q -n sphinx_gallery-0.17.1
cd %{_builddir}/sphinx_gallery-0.17.1
pushd ..
cp -a sphinx_gallery-0.17.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723046600
